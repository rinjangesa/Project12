package com.example.project12.helper;
...
public class DbHelper extends SQLiteOpenHelper
{
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        String sql = "CREATE TABLE bunga (/*0*/id INTEGER PRIMARY KEY AUTOINCREMENT, /*1*/nama VARCHAR(255), /*2*/harga VARCHAR(50));";
